...
MODEL="$HOME/sparsesurf_shared/outputs/smallroom21_geometrylocked_dwt_10000_fullres"
...
echo
echo "============================================================"
echo "STAGE 1: SPARSESURF + GEOMETRY-LOCKED DWT 10K"
echo "============================================================"
