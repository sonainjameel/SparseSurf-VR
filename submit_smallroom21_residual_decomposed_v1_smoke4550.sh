...
MODEL="$HOME/sparsesurf_shared/outputs/smallroom21_residual_decomposed_v1_smoke4550_v2"
...
python -u train.py \
    ...
    --n_views 21 \
    --iterations 4550 \
    --test_iterations 4550 \
    --save_iterations 4550 \
    --total_virtual_num 240 \
    --foundation_stereo_ckpt "$CKPT"

POINT_CLOUD="$MODEL/point_cloud/iteration_4550/point_cloud.ply"
