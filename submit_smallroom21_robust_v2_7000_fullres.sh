...
MODEL="$HOME/sparsesurf_shared/outputs/smallroom21_sparsesurf_robust_geometry_v2_7000_fullres"

echo "============================================================"
echo "SparseSurf — SmallRoom — 21 views — 7k"
echo "============================================================"
echo "Job:          $PBS_JOBID"
echo "Node:         $(hostname)"
echo "Scene:        $SCENE"
...
echo
echo "============================================================"
echo "STAGE 1: SPARSESURF 7K TRAINING"
echo "============================================================"
...
python -u train.py \
    ...
    --max_all_points 3000000 \
    --densify_min_observations 3 \
    --test_iterations 7000 \
    --save_iterations 7000 \
    --total_virtual_num 240 \
    --foundation_stereo_ckpt "$CKPT"

POINT_CLOUD="$MODEL/point_cloud/iteration_7000/point_cloud.ply"

if [ ! -f "$POINT_CLOUD" ]; then
    echo "ERROR: Expected 7k Gaussian model missing:"
    echo "$POINT_CLOUD"
    exit 1
fi
...
echo
echo "============================================================"
echo "SPARSESURF SIDEROOM27 21-VIEW 7K SUCCESS"
echo "============================================================"
